...
//           tabs: const [
//             Tab(text: 'En Transits'),
//             Tab(text: 'En Consommation'),
//           ],
//         ),
//       ),
//       body: TabBarView(
...
//               border: Border.all(
//                 color: isHovered ? Colors.amber : Colors.transparent, // Bordure amber au survol
//                 width: 2,
//               ),
//               boxShadow: [
//                 BoxShadow(
...
//                         ),
//                       ),
//                       if (transit['proposedPrice'] != null) // Affiche le prix proposé s'il existe
//                         Padding(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          labelStyle: const TextStyle(
            fontSize: 18, // Augmente la taille du texte des onglets sélectionnés
            fontWeight: FontWeight.bold,
          ),
          unselectedLabelStyle: const TextStyle(
            fontSize: 16, // Taille légèrement plus petite pour les onglets non sélectionnés
            fontWeight: FontWeight.normal,
          ),
          labelColor: Colors.white, // Couleur du texte pour l'onglet sélectionné
          unselectedLabelColor: Colors.black, // Couleur du texte pour les onglets non sélectionnés
          indicator: UnderlineTabIndicator(
            borderSide: BorderSide(
              color: Colors.black, // Couleur du soulignement
              width: 3, // Épaisseur du soulignement
            ),
            insets: const EdgeInsets.symmetric(horizontal: 16), // Marges du soulignement
          ),
          tabs: const [
            Tab(text: 'En Transits'),
            Tab(text: 'En Consommation'),
