...
import 'package:tramoo/data/screens/cars_info.dart';
            ...
            SizedBox(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => Cars_info()));
                      },
                      child: Container(
                          padding: const EdgeInsets.only(right: 10), // Espacement
                          child: Stack(
                              alignment: Alignment
                                  .bottomLeft, // Alignement du texte en bas
                              children: [
                                ClipRRect(
                                ...
                                child: CircleAvatar(
                                  ...
                                  child: IconButton(
                                    icon: Icon(
                                      ...
                                      color:
                                      Colors.red, // Icône YouTube en rouge
                                      size: 18, // Taille de l'icône réduite
                                    ),
                                    onPressed: () {
                      ...
                      return Column(
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Image.asset(
                              PiecesImages[index],
                              height: PiecesImageHeights[
                              index], // Utilisation de la hauteur spécifique
                              width: PiecesImageWidths[index],
                              fit: BoxFit.cover,
                            ),
                          ),
                          SizedBox(
                              height: 8), // Espace entre l'image et le texte
                          Text(
                            PiecesNames[index],
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
              ...
              child: TextField(
                decoration: InputDecoration(
                  ...
                  prefixIcon: const Icon(Icons.search,
                      color: Color(0xFF8C9199), size: 30),
